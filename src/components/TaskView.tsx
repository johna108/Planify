...
export function TaskView() {
  ...
  return (
    <div className="h-full rounded-xl border border-slate-200 bg-white p-4 flex flex-col">
      <div className="mb-4 flex flex-wrap items-start justify-between gap-2">
        ...
        <div className="flex w-full flex-wrap items-center gap-2 sm:w-auto sm:justify-end">
          <button
            ...
            className="text-xs font-medium text-slate-600 px-2.5 py-1 rounded-md border border-slate-200 bg-white hover:bg-slate-50 disabled:opacity-50 disabled:cursor-not-allowed"
          ...
          <button
            ...
            type="button"
            className="text-xs font-medium text-slate-600 px-2.5 py-1 rounded-md border border-slate-200 bg-white hover:bg-slate-50"
          >
                  ...
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center justify-between gap-2 mb-1">
                        ...
                        <span
                          className={`text-[10px] font-semibold px-2 py-0.5 rounded-md border ${getPriorityColor(
                            task.priority
                          )}`}
                        >
                          {task.priority}
                      ...
                      <div className="mt-2 flex flex-col gap-2 sm:flex-row sm:items-center sm:justify-between">
                        <div className="inline-flex max-w-full items-center gap-1.5 rounded-md bg-slate-100 px-2 py-1 text-xs text-slate-500">
                          <Clock size={12} />
                        ...
                        <div className="flex w-full flex-wrap items-center gap-1.5 sm:w-auto sm:justify-end">
                          <button
                            ...
                            type="button"
                            className="inline-flex items-center gap-1 rounded-md border border-slate-200 bg-white px-2 py-1 text-[10px] font-medium text-slate-600 transition-colors hover:bg-slate-50"
                            title="Edit task"
                          >
                            <Pencil size={11} />
                            Edit
                          ...
                          {(task.status === "Pending" || task.status === "Rescheduled") && (
                            <button
                              ...
                              type="button"
                              className="rounded-md border border-slate-200 bg-white px-2 py-1 text-[10px] font-medium text-slate-600 transition-colors hover:bg-slate-50"
